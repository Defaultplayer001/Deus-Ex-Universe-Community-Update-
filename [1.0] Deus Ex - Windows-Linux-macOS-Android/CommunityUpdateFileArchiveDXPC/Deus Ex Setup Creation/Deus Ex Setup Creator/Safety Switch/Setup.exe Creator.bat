...
"%~dp0..\ResourceHacker.exe" -open "%~dp0..\..\Deus Ex Mod.exe" -save "%~dp0..\..\DeusExModFullName Installer %Year%-%Month%-%Day% %Hour%%Minute%.exe" -action addskip -res "%~dp0..\..\subdir\Help\DeusEx.ico" -mask ICONGROUP,MAINICON,
