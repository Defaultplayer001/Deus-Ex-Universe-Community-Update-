...
GlideDrv.GlideRenderDevice=3dfx renderer emulator. Recommended for the most accurate appearance. 
D3DDrv.D3DRenderDevice=Direct3D hardware rendering. Not recommended - Outdated
OpenGLDrv.OpenGLRenderDevice=OpenGL support.
MetalDrv.MetalRenderDevice=For users with S3 Savage4 video cards. Not recommended - Outdated
Galaxy.GalaxyAudioSubsystem=Default UnrealEngine Audio Subsystem.
ALAudio.ALAudioSubsystem=Experimental OpenAL Support. Recommended for the best audio.
D3D8Drv.D3D8RenderDevice=Direct3D8 renderer. Not recommended - Outdated
D3D9Drv.D3D9RenderDevice=Direct3D9 renderer.
D3D10Drv.D3D10RenderDevice=Direct3D10 renderer.
SwFMOD.SwFMOD=Experimental FMOD Support
OpenGLDrvU.OpenGLRenderDevice=Updated OpenGL support.
