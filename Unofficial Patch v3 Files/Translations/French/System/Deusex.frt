[General]
Start="Deus Ex (Lancement)"
Exit="Deus Ex (fin)"
Run="Deus Ex (en cours)"
Product="Deus Ex"
...
UnfamiliarName="DEFAULT UNFAMILIAR NAME - NOTIFIEZ CE BUG"

[DeusExPlayer]
InventoryFull="Vous n'avez pas assez de place dans votre inventaire pour prendre: %s."
TooMuchAmmo="Vous avez déjà suffisamment de munitions de ce type."
TooHeavyToLift="Cet objet est trop lourd pour être soulevé."
CannotLift="Vous ne pouvez pas soulever cet objet."
NoRoomToLift="Il n'y a pas assez de place pour soulever cet objet."
CanCarryOnlyOne="Vous ne pouvez transporter qu'un(e) seul(e) %s."
CannotDropHere="Vous ne pouvez pas jeter cela ici."
HandsFull="Vous avez les mains pleines."
NoteAdded="Note enregistrée: consultez votre PersOrdinateur pour plus de détails."
GoalAdded="Nouvel objectif: consultez votre PersOrdinateur pour plus de détails."
PrimaryGoalCompleted="Objectif principal atteint."
...
LegsString="Jambes"
WithTheString=" avec le "
WithString=" avec "
PoisonString=" avec du poison mortel"
BurnString=" en le brûlant fortement"
NoneString="Aucun"
...
[Skill]
skillLevelStrings[0]="NUL"
skillLevelStrings[1]="NOVICE"
skillLevelStrings[2]="QUALIFIE"
skillLevelStrings[3]="EXPERT"
...
[Augmentation]
EnergyRateLabel="Taux de consommation énergétique: %d Unités/Minute." 
OccupiesSlotLabel="Occupe l'emplacement: %s."
AugLocsText[0]="Tête"
AugLocsText[1]="Yeux"
AugLocsText[2]="Torse"
AugLocsText[3]="Bras"
AugLocsText[4]="Jambes"
AugLocsText[5]="Derme"
AugLocsText[6]="Par défaut"
AugActivated="%s activé(e)"
AugDeactivated="%s désactivé(e)"
AugAlreadyHave="%s déjà au niveau maximum."
AugNowHave="%s amélioré(e) au niveau %d"
AugNowHaveAtLevel="Modification %s actuellement au niveau %d."
AlwaysActiveLabel="[Active en permanence]"
CanUpgradeLabel="(peut être améliorée)"
CurrentLevelLabel="Niveau actuel: %d."
...
msgLockAcquire="EN ACQUISITION"
msgLockLocked="CIBLE VERROUILLEE"
msgRangeUnit="PIEDS"
msgTimeUnit="SEC"
msgMassUnit="LIVRES"
...
msgInfoRecoil="Recul:"
msgInfoAccuracy="Précision théorique:"
msgInfoAccRange="Préc. portée:"
msgInfoMaxRange="Portée max.:"
msgInfoMass="Masse:"
msgInfoLaser="Visée laser:"
msgInfoScope="Lunette:"
msgInfoSilencer="Silencieux:"
msgInfoNA="INDIS"
msgInfoYes="OUI"
msgInfoNo="NON"
msgInfoAuto="AUTO"
msgInfoSingle="UN COUP"
msgInfoRounds="BALLES"
msgInfoRoundsPerSec="BALLES/SEC"
msgInfoSkill="Niveau:"
msgInfoWeaponStats="Statistiques de l'arme:"
PickupMessage="Vous avez trouvé"
ItemName="DEFAULT WEAPON NAME - NOTIFIEZ CE BUG"

[DeusExCarcass]
msgSearching="Résultat de la fouille:"
...
[DeusExMover]
msgKeyLocked="Votre nano-sélecteur a verrouillé cette serrure."
msgKeyUnlocked="Votre nano-sélecteur a déverrouillé cette serrure."
...
[DataVaultImage]
PickupMessage="Image enregistrée sur le PersOrdinateur."
...
PickupMessage="Vous avez trouvé"
ItemName="DEFAULT AMMO NAME - NOTIFIER CE BUG"
ItemArticle=""
...
OnLabel="Active"
OffLabel="Désactivée"
DisabledLabel="Piratée"
AttackingAlliesLabel="Alliés"
AttackingEnemiesLabel="Ennemis"
AttackingEverythingLabel="Toutes cibles"
NoSignalLabel="AUCUN SIGNAL"
OpenLabel="Ouverte"
ClosedLabel="Fermée"
LockedLabel="Verrouillée"
UnlockedLabel="Déverrouillée"
FriendlyLabel="Détection d'ennemis"
HostileLabel="Détection d'alliés"

[MenuScreenLoadGame]
strHeaderNameLabel="Nom"
...
SaveCountLabel="Nb sauvegardes: %s|n"
FileSizeLabel="Taille du fichier: %dMB"
...
msgWeapon="Arme:"
msgNone="Aucune"
msgScanning1="* Aucune cible *"
msgScanning2="* Détection *"
msgADSTracking="* SDA en acquisition *"
...
msgLegs="Jambes"
SpottedTeamString="Vous avez localisé un équipier !"
YouArePoisonedString="Vous avez été empoisonné !"
YouAreBurnedString="Vous brûlez !"
TurretInvincibleString="Seuls les dommages par GIE affectent les mitrailleuses autonomes !"
CameraInvincibleString="Seuls les dommages par GIE affectent les caméras !"
NeutBurnPoisonString="(Utilisez des Médikits pour neutraliser instantanément)"
OnlyString="Plus que "
KillsToGoString=" autres tués et "
KillToGoString=" autre tué et "
LessThanMinuteString="Moins d'une minute avant la fin et "
LessThanXString1="Moins de "
LessThanXString2=" minutes avant la fin et "
LeadsMatchString=" mène la partie !"
TiedMatchString="la partie est très serrée !"
WillWinMatchString=" gagnera la partie !"
OutOfRangeString="(hors de portée)"
LostLegsString="Vous avez perdu vos jambes !"
DropItem1String="Vous pouvez utiliser <"
DropItem2String="> pour jeter un objet en main."
msgTeammateHit="Vous avez touché votre équipier !"
msgTeamNsf="Vous êtes dans l'Equipe NSF !"
msgTeamUnatco="Vous êtes dans l'Equipe UNATCO !"
UseString="Utilisez <"
TeamTalkString="> pour envoyer des messages à l'équipe."
TalkString="> pour envoyer de simples messages de chat."
YouKilledTeammateString="Vous avez tué un équipier !"
TeamLAMString="Vous ne pouvez pas prendre la grenade de votre équipier !"
TeamComputerString="Cet ordinateur appartient déjà à votre équipe !"
NoCloakWeaponString="Vous ne pouvez pas bénéficier de la Cape si votre arme est dégainée !"
TeamHackTurretString="Cette mitrailleuse autonome appartient déjà à votre équipe !"
KeyNotBoundString="Touche non liée"
OutOfAmmoString="Munitions épuisées !"
 
[ComputerUIWindow]
ButtonLabelLogin="|&Login"
ButtonLabelLogout="|&Logout"
ButtonLabelCancel="|&Annuler"
ButtonLabelSpecial="|&Options spéciales"

[PersonaInventoryInfoWindow]
AmmoLabel="Munitions:"
AmmoRoundsLabel="Stock:"
ShowAmmoDescriptionsLabel="Description des munitions"

[FrobDisplayWindow]
msgLocked="Verrouillé"
msgUnlocked="Déverrouillé"
msgLockStr="Serrure: "
msgDoorStr="Résistance: "
msgHackStr="Cryptage: "
msgInf="INF"
msgHacked="Piraté"
msgPick="p.partout"
...
[AutoTurret]
ItemName="Socle de mitrailleuse autonome"
titleString="MitrailleuseAuto"
...
[UNATCOTroop]
FamiliarName="Soldat de l'UNATCO"
...
AmmoLoadedLabel="%s chargé(e)"
WeaponUpgradedLabel="%s amélioré(e)"
CannotBeDroppedLabel="%s ne peut être jeté(e) ici."
AmmoInfoText="Cliquez sur l'icone pour afficher une liste des munitions."
AmmoTitleLabel="Munitions"
NoAmmoLabel="Pas de munitions disponibles."

[ATM]
msgLockedOut="Distributeur inaccessible pendant encore %d secondes."
ItemName="Distributeur bancaire"

[AlarmUnit]
msgActivated="Alarme déclenchée"
msgDeactivated="Alarme désactivée"
ItemName="Panneau de contrôle d'alarme"
...
ButtonActionPressedLabel="Enfoncé"
ListNormalLabel="Normal"
ListFocusLabel="Mise au point"
EditLabel="Editer"
TitleLabel="Titre"

[PersonaScreenHealth]
MedKitUseText="Pour soigner une partie spécifique du corps, cliquez sur la zone à guérir puis sur le bouton Soigner."
HealthTitleText="Santé"
HealAllButtonLabel="S|&oin auto."
HealthLocationHead="Tête"
HealthLocationTorso="Torse"
HealthLocationRightArm="Bras G"
HealthLocationLeftArm="Bras G"
HealthLocationRightLeg="Jambe D"
...
[SecurityCamera]
msgActivated="Caméra active"
msgDeactivated="Caméra désactivée"
ItemName="Caméra de surveillance"
...
DeleteNoteButtonLabel="|&Supprimer Note"
AddNoteButtonLabel="|&Ajouter"
ShowNotesLabel="Afficher |&Notes"

[PersonaScreenAugmentations]
AugmentationsTitleText="Modifications"
UpgradeButtonLabel="|&Améliorer"
ActivateButtonLabel="Acti|&ver"
DeactivateButtonLabel="Désac|&tiver"
UseCellButtonLabel="Util|&iser cellule"
AugCanUseText="Pour amplifier une modification, cliquez sur la modification que vous souhaitez amplifier puis sur le bouton Améliorer."
BioCellUseText="Pour apporter l'Energie bio-électrique nécessaire à vos modifications, cliquez sur le bouton Utiliser cellule."
AugLocationDefault="Par défaut"
AugLocationCranial="Tête"
AugLocationEyes="Yeux"
AugLocationArms="Bras"
AugLocationLegs="Jambes"
AugLocationTorso="Torse"
...
[MenuScreenRGB]
HUDBackgroundTranslucentLabel="Fonds HUD|& transparents"
HUDBordersTranclucentLabel="Bordures HUD|& transparents"
MenusBackgroundTranslucentLabel="Fonds des menus|& transparents"
RedLabel="|&Rouge"
GreenLabel="|&Vert"
BlueLabel="|&Bleu"
TabHUDLabel="|&HUD"
...
actionButtons[0]="(align=HALIGN_Right,Action=AB_Other,Text="|&Fermer",Key="CLOSE")"
actionButtons[1]="(align=HALIGN_Right,Action=AB_Other,Text="|&Charger",Key="LOAD")"
actionButtons[2]="(align=HALIGN_Right,Action=AB_Other,Text="|&Sauvegarder",Key="SAVE")"
...
[MedicalBot]
FamiliarName="Robot-med"
UnfamiliarName="Robot-med"

[MenuScreenAdjustColorsExample]
TitleBarLabel="Barre de titre"
TextHeaderLabel="Texte pour test"
TextNormalLabel="Texte pour test"
...
msgReloading="---"
AmmoLabel="COUPS"
ClipsLabel="CHARGEURS"

[MJ12Commando]
FamiliarName="Commando des MJ12"
...
RechargeTitle="INTERFACE DU ROBOT-MEC"
RepairBotInfoText="Peut rétablir %d points d'Energie toutes les %d secondes."
RepairBotStatusLabel="Etat du robot-mec:"
ReadyLabel="Prêt !"
SecondsPluralLabel="Recharge: %d secondes"
SecondsSingularLabel="Recharge: %d seconde"
BioStatusLabel="Bio-énergie:"
RepairBotRechargingLabel="|n|nLe robot-mec est en train de Recharger. Merci de patienter."
RepairBotReadyLabel="|n|nLe robot-mec est prêt, vous pouvez recharger."
...
ButtonDowngradeLabel="|&Déclasser"
HeaderNameLabel="Nom usuel"
HeaderCodeNameLabel="Nom de code"
HeaderAppearanceLabel="Aspect"
HeaderSkillsLabel="Compétences"
...
msgAccessGranted="~~ACCORDE~~"

[HUDReceivedDisplay]
TextReceivedLabel="Reçu:"

[InformationDevices]
msgNoText="Il n'y a rien d'intéressant à lire."
ImageLabel="[Image: %s]"
AddedToDatavaultLabel="Image %s ajoutée au PersOrdinateur."
...
[SpyDrone]
ItemName="Espieur télécommandé"

[HUDMedBotHealthScreen]
MedbotInterfaceText="INTERFACE DU ROBOT-MED"
HealthInfoTextLabel="Peut soigner %d unités de façon homogène entre les différentes zones blessées de votre corps."
MedBotRechargingLabel="|nLe robot-med est en train de Recharger. Veuillez patienter."
MedBotReadyLabel="|nLe robot-med est prêt, vous pouvez maintenant être soigné."
...
[RepairBot]
FamiliarName="Robot-mec"
UnfamiliarName="Robot-mec"

[PersonaNavBarWindow]
InventoryButtonLabel="|&Inventaire"
HealthButtonLabel="|&Santé"
AugsButtonLabel="|&Mods"
SkillsButtonLabel="|&Compétences"
GoalsButtonLabel="|&Objectifs/Notes"
ConsButtonLabel="|&Conversations"
ImagesButtonLabel="|&Images"
LogsButtonLabel="|&Carnets"
...
FunctionText[2]="Poser/jeter objet"
FunctionText[3]="Ranger objet"
FunctionText[4]="Avancer"
...
FunctionText[13]="Se baisser"
FunctionText[14]="Vue souris"
FunctionText[15]="Regarder vers le haut"
FunctionText[16]="Regarder vers le bas"
...
FunctionText[29]="Faire une capture d'écran"
FunctionText[30]="Activer l'écran d'inventaire"
FunctionText[31]="Activer l'écran de santé"
FunctionText[32]="Activer l'écran des modifications"
FunctionText[33]="Activer l'écran de capacité"
FunctionText[34]="Activer l'écran d'objectifs/notes"
FunctionText[35]="Activer l'écran de conversation"
FunctionText[36]="Activer l'écran des images"
...
keyDisplayNames[3]="(inputKey=IK_CapsLock,displayName="Ver Maj")"
keyDisplayNames[4]="(inputKey=IK_PageUp,displayName="Page haut")"
keyDisplayNames[5]="(inputKey=IK_PageDown,displayName="Page bas")"
keyDisplayNames[6]="(inputKey=IK_PrintScrn,displayName="Impr écran")"
keyDisplayNames[7]="(inputKey=IK_GreyStar,displayName="Astérisque du pavé num.")"
keyDisplayNames[8]="(inputKey=IK_GreyPlus,displayName="Plus du pavé num. ")"
keyDisplayNames[9]="(inputKey=IK_GreyMinus,displayName="Moins du pavé num. ")"
keyDisplayNames[10]="(inputKey=IK_GreySlash,displayName="/ du pavé num. ")"
keyDisplayNames[11]="(inputKey=IK_NumPadPeriod,displayName="Point du pavé num.")"
keyDisplayNames[12]="(inputKey=IK_NumLock,displayName="Verr num")"
keyDisplayNames[13]="(inputKey=IK_ScrollLock,displayName="Arrêt défil")"
keyDisplayNames[14]="(inputKey=IK_LShift,displayName="Maj gauche")"
keyDisplayNames[15]="(inputKey=IK_RShift,displayName="Maj droit")"
keyDisplayNames[16]="(inputKey=IK_LControl,displayName="Ctrl gauche")"
keyDisplayNames[17]="(inputKey=IK_RControl,displayName="Ctrl droit")"
keyDisplayNames[18]="(inputKey=IK_MouseWheelUp,displayName="Molette souris vers haut")"
keyDisplayNames[19]="(inputKey=IK_MouseWheelDown,displayName="Molette souris vers bas")"
keyDisplayNames[20]="(inputKey=IK_MouseX,displayName="Souris X")"
keyDisplayNames[21]="(inputKey=IK_MouseY,displayName="Souris Y")"
keyDisplayNames[22]="(inputKey=IK_MouseZ,displayName="Souris Z")"
keyDisplayNames[23]="(inputKey=IK_MouseW,displayName="Souris W")"
keyDisplayNames[24]="(inputKey=IK_LeftBracket,displayName="^")"
keyDisplayNames[25]="(inputKey=IK_RightBracket,displayName="$")"
keyDisplayNames[26]="(inputKey=IK_SingleQuote,displayName="ù")"
keyDisplayNames[27]="(inputKey=IK_Joy1,displayName="Bouton joystick 1")"
keyDisplayNames[28]="(inputKey=IK_Joy2,displayName="Bouton joystick 2")"
keyDisplayNames[29]="(inputKey=IK_Joy3,displayName="Bouton joystick 3")"
keyDisplayNames[30]="(inputKey=IK_Joy4,displayName="Bouton joystick 4")"
...
keyDisplayNames[37]="(inputKey=IK_JoyPovUp,displayName="Joystick haut")"
keyDisplayNames[38]="(inputKey=IK_JoyPovDown,displayName="Joystick bas")"
keyDisplayNames[39]="(inputKey=IK_JoyPovLeft,displayName="Joystick gauche")"
keyDisplayNames[40]="(inputKey=IK_JoyPovRight,displayName="Joystick droite")"
keyDisplayNames[41]="(inputKey=IK_Ctrl,displayName="Ctrl")"
keyDisplayNames[42]="(inputKey=IK_Left,displayName="Flèche gauche")"
keyDisplayNames[43]="(inputKey=IK_Right,displayName="Flèche droite")"
keyDisplayNames[44]="(inputKey=IK_Up,displayName="Flèche haut")"
keyDisplayNames[45]="(inputKey=IK_Down,displayName="Flèche bas")"
keyDisplayNames[46]="(inputKey=IK_Insert,displayName="Inser")"
keyDisplayNames[47]="(inputKey=IK_Home,displayName="Origine")"
keyDisplayNames[48]="(inputKey=IK_Delete,displayName="Suppr")"
keyDisplayNames[49]="(inputKey=IK_End,displayName="Fin")"
keyDisplayNames[50]="(inputKey=IK_NumPad0,displayName="Pavé num. 0")"
keyDisplayNames[51]="(inputKey=IK_NumPad1,displayName="Pavé num. 1")"
keyDisplayNames[52]="(inputKey=IK_NumPad2,displayName="Pavé num. 2")"
keyDisplayNames[53]="(inputKey=IK_NumPad3,displayName="Pavé num. 3")"
keyDisplayNames[54]="(inputKey=IK_NumPad4,displayName="Pavé num. 4")"
keyDisplayNames[55]="(inputKey=IK_NumPad5,displayName="Pavé num. 5")"
keyDisplayNames[56]="(inputKey=IK_NumPad6,displayName="Pavé num. 6")"
keyDisplayNames[57]="(inputKey=IK_NumPad7,displayName="Pavé num. 7")"
keyDisplayNames[58]="(inputKey=IK_NumPad8,displayName="Pavé num. 8")"
keyDisplayNames[59]="(inputKey=IK_NumPad9,displayName="Pavé num. 9")"
keyDisplayNames[60]="(inputKey=IK_Period,displayName="Deux-points")"
keyDisplayNames[61]="(inputKey=IK_Comma,displayName="Point virgule")"
keyDisplayNames[62]="(inputKey=IK_Backslash,displayName="Astérique")"
keyDisplayNames[63]="(inputKey=IK_Semicolon,displayName="M")"
keyDisplayNames[64]="(inputKey=IK_Equals,displayName="Egal")"
keyDisplayNames[65]="(inputKey=IK_Slash,displayName="Point d'exclamation")"
keyDisplayNames[66]="(inputKey=IK_Enter,displayName="Entrée")"
...
[TAD]
ItemName="Répondeur téléphonique"

[Credits]
msgCreditsAdded="%d crédits ajoutés"
ItemName="Bon de crédit"
beltDescription="CREDITS"

[PersonaScreenGoals]
GoalsTitleText="Objectifs"
PrimaryGoalsHeader="Objectifs principaux"
SecondaryGoalsHeader="Objectifs secondaires"
DisplayCompletedGoals="Afficher les |&objectifs atteints"
NoGoalsLabel="Aucun"
GoalCompletedText="[Atteint]"
...
PressSpace="Appuyez sur [Echap] après avoir modifié une note"
EscapeToCancel="Cliquez sur l'image pour créer une note, appuyez sur [Echap] pour annuler"
...
AllAccountsHeader="Comptes tout utilisateur"
...
ButtonLabelWithdraw="|&Retirer"
ButtonLabelClose="|&Fermer"
BalanceLabel="Montant actuel:"
WithdrawAmountLabel="Montant à retirer:"
InstructionText="NO. DE COMPTE: %d|nVeuillez entrer la somme |nque vous souhaitez retirer."
InvalidAmountLabel="MONTANT INCORRECT"
InsufficientCreditsLabel="CREDITS INSUFFISANTS"
CreditsWithdrawnLabel="CREDITS RETIRES"
StatusText="PNGBS//GLOBAL//PUB:3902.9571[wd]"
HackedText="DISTRIBUTEUR PIRATE"
Title="Système bancaire mondial PageNet"
...
SecurityButtonLabel="|&Sécurité"
EmailButtonLabel="|&Email"
Title="Options spéciales"
ComputerNodeFunctionLabel="Options spéciales"
...
[SecurityBot3]
FamiliarName="Robot-vigile"
UnfamiliarName="Robot-vigile"

[MenuChoice_Resolution]
helpText="Changer la résolution vidéo"
actionText="Résolution de l'écran"
...
[ComputerSecurity]
ItemName="Terminal de sécurité"

[TrashPaper]
ItemName="Papier"

[HUDMedBotAugCanWindow]
AugContainsText="Contient:|n"
...
[RiotCop]
FamiliarName="Policier anti-émeute"
UnfamiliarName="Policier anti-émeute"

[Fly]
FamiliarName="Mouche"
UnfamiliarName="Mouche"
...
[Poolball]
ItemName="Boule de billard"

[HUDMedBotNavBarWindow]
HealthButtonLabel="   |&Santé   "
AugsButtonLabel="   |&Modifications   "
...
ButtonLabelClose="Fermer"
LoginInfoText="Désolé, ce distributeur bancaire est hors service (ERR 06MJ12)|n|nNous vous prions de bien vouloir nous excuser pour la gêne occasionnée et vous invitons à consulter l'un des autres 231 000 distributeurs bancaires PageNet."
StatusText="PNGBS//GLOBAL//PUB:3902.9571[dsbld]"
Title="Système bancaire mondial PageNet"

[MenuChoice_Volume]
VolumeOffText="DESACTIVE"
VolumeMaxText="MAX"
...
ButtonNames[4]="Entraînement"
ButtonNames[5]="Intro"
ButtonNames[6]="Crédits"
ButtonNames[7]="Retour au jeu"
ButtonNames[8]="Multijoueur"
...
[WIB]
FamiliarName="Femme en noir"
UnfamiliarName="Femme en noir"

[MIB]
FamiliarName="Homme en noir"
UnfamiliarName="Homme en noir"
...
actionText="Textures |&détail"
configSetting="ini:Engine.Engine.GameRenderDevice DetailTextures"

[MenuChoice_Decals]
helpText="La désactivation des decals peut améliorer les performances des machines les plus lentes."
actionText="De|&cals"
configSetting="ini:Engine.Engine.ViewportManager Decals"

[MenuChoice_MouseSensitivity]
helpText="Modifie la sensibilité de la souris."
actionText="|&Sensibilité de la souris"

[MenuChoice_MaxLogLines]
helpText="Nombre maximum de lignes des carnets visibles à l'écran à tout moment."
actionText="Max. lignes du carnet"

[MenuChoice_LogTimeoutValue]
msgSecond="s"
helpText="Sélectionnez la période maximale durant laquelle les messages des carnets restent affichés à l'écran."
actionText="|&Durée maximale d'affichage"

[HKMilitary]
FamiliarName="Soldat chinois"
UnfamiliarName="Soldat chinois"
...
RestartMessage="Cette modification ne prendra effet que lorsque vous relancerez Deus EX."
helpText="De meilleure qualité, le son 16 bits utilise deux fois plus de mémoire que le 8 bits, utilisez ce dernier si vous disposez de peu de mémoire."
actionText="Qualité |&sonore"
...
helpText="Détermine la profondeur de la texture des couleurs. Une texture à 32 bits est meilleure si votre matériel peut l'utiliser."
RestartTitle="Texture des couleurs"
RestartMessage="Cette modification ne prendra effet que lorsque vous relancerez Deus EX."
actionText="Prof. de la texture des couleurs"
...
[LowerClassFemale]
FamiliarName="Ouvrière"
UnfamiliarName="Ouvrière"

[TerroristCommander]
FamiliarName="Chef des terroristes"
UnfamiliarName="Chef des terroristes"
...
[SpiderBot]
FamiliarName="Arachnorobot"
UnfamiliarName="Arachnorobot"
...
helpText="Un échantillonnage bas offre un son de qualité moindre, mais utilise peu le CPU"
actionText="Echantillonnage"
configSetting="ini:Engine.Engine.AudioDevice OutputRate"
enumText[0]="11025Hz"
enumText[1]="22050Hz"
enumText[2]="44100Hz"
RestartTitle="Qualité sonore"
RestartMessage="Ce changement ne prend effet qu'au redémarrage de Deus Ex."
...
Title="Sélection de la difficulté du combat"
ButtonNames[0]="Facile"
ButtonNames[1]="Normal"
ButtonNames[2]="Difficile"
ButtonNames[3]="Réaliste"
ButtonNames[4]="Menu précédent"

[AttackHelicopter]
ItemName="Hélicoptère offensif"

[MilitaryBot]
FamiliarName="Robot militaire"
...
[HangingChicken]
ItemName="Poulet égorgé"

[BarrelFire]
ItemName="Brasero"

[Doctor]
FamiliarName="Médecin"
...
[SpiderBot2]
FamiliarName="Arachnorobot miniature"
UnfamiliarName="Arachnorobot miniature"
...
[ControlPanel]
ItemName="Panneau de commande électronique"
...
helpText="Palette utilisée dans tous les menus."
actionText="Palette des menus"
...
Description="Un micro-receveur unilatéral permet aux agents se trouvant sur le terrain de recevoir des messages du commandement et d'enregistrer, pour les consulter ultérieurement, les cartes, conversations et notes pertinentes.|n|n<UNATCO OPS FILE NOTE JR133-VIOLET> Ce système est ultra-sophistiqué, alors ne vous attendez à aucune amélioration. -- Jaime Reyes <END NOTE>|n|nAUCUN AMPLIFICATION"
...
Description="Ce système d'identification des alliés ou ennemis utilise des algorithmes heuristiques sophistiqués pour associer des objets perçus à des catégories de danger connues.|n|nAUCUNE AMPLIFICATION"
...
[CeilingFan]
ItemName="Pales du ventilateur du plafond"

[CeilingFanMotor]
ItemName="Moteur de ventilateur suspendu"

[Female4]
FamiliarName="Femme"
UnfamiliarName="Femme"

[ClothesRack]
ItemName="Vêtements suspendus"
...
helpText="Change l'aspect du viseur."
actionText="Viseur"

[DartFlare]
ItemName="Fléchette incandescente"

[MenuChoice_ObjectNames]
helpText="Lorsque cette option est activée, le nom des objets sélectionnés dans le décor s'affiche"
actionText="|&Nom des objets"

[MenuChoice_ReverseStereo]
helpText="Lorsque cette option est activée, les canaux stéréo droit et gauche sont inversés."
actionText="|&Stéréo inversée"
configSetting="ini:Engine.Engine.AudioDevice ReverseStereo"

[MenuChoice_SoundVolume]
helpText="Règle le volume des effets sonores."
actionText="Volume des |&effets sonores"
configSetting="ini:Engine.Engine.AudioDevice SoundVolume"

[MenuChoice_Subtitles]
helpText="Lorsque l'option sous-titres est activée, les dialogues s'affichent à l'écran."
actionText="|&Sous-titres"

[MenuChoice_ToggleCrouch]
helpText="Maintient le joueur indéfiniment en position debout ou accroupi."
actionText="|&Position constante"
...
Title="Sauvegarde palette"
actionButtons[1]="(Text="Sauvegarder thème",Key="SAVE")"

[ComputerSecurityChoice_Turret]
actionText="|&Mitrailleuse auto."
enumText[0]="Piratée"
enumText[1]="Alliés"
enumText[2]="Ennemis"
enumText[3]="Tout"
...
helpText="Règle le volume des voix."
actionText="Volume des voix"
...
helpText="Cette option détermine les modifications affichée dans le HUD."
actionText="Affichage des modif. HUD"
enumText[0]="Activé"
enumText[1]="Toutes"

[GasGrenade]
ItemName="Grenade fumigène"
...
actionText="|&Luminosité"
configSetting="ini:Engine.Engine.ViewportManager Brightness"

[MenuChoice_AlwaysRun]
helpText="Lorsque cette option est activée, le joueur court tout le temps."
...
actionText="|&Bordures HUD Visibles"

[MenuChoice_HUDBorderTranslucency]
helpText="Lorsque le mode transparence est activé, les bordures HUD sont transparentes"
actionText="Transparence des |&bordures HUD"

[MenuChoice_InvertMouse]
helpText="Inverse l'axe vertical de la souris de manière à ce que lorsque vous la déplacez vers le haut, vous regardez vers le bas et vice versa."
actionText="Inversion |&souris"

[MenuChoice_HUDTranslucency]
helpText="Lorsque la transparence est activée, le décor est visible à travers les écrans de HUD et Utilisateur-interface."
actionText="Tran|&sparence des fonds HUD"

[MenuChoice_MenuTranslucency]
helpText="Lorsque la transparence est activée, le décor est visible au travers des menus."
actionText="|&Transparence des menus"

[MenuChoice_MusicVolume]
helpText="Règle le volume de la musique."
actionText="Volume de la |&musique"
configSetting="ini:Engine.Engine.AudioDevice MusicVolume"

[MenuChoice_SurroundSound]
helpText="Active le support Dolby Surround Sound. Processeur sonore Dolby Pro-Logic Surround requis."
actionText="Son |&Dolby Surround"
configSetting="ini:Engine.Engine.AudioDevice UseSurround"

[MenuChoice_GoreLevel]
helpText="Lorsque cette option est réglée sur bas, il n'y a que peu de sang dans le jeu."
actionText="|&Degré de violence"
enumText[0]="Bas"
enumText[1]="Normal"

[MenuChoice_FullScreen]
helpText="Permet de choisir de jouer en plein écran ou dans une fenêtre."
actionText="Choix du mode |&plein écran"

[MenuChoice_Use3DHardware]
helpText="Active le périphérique sonore 3D."
actionText="Support |&périphérique 3D"
configSetting="ini:Engine.Engine.AudioDevice Use3dHardware"
RestartTitle="Qualité sonore"
RestartMessage="Ce changement ne prendra effet que lorsque vous relancerez Deus Ex."

[MenuChoice_WeaponAutoReload]
helpText="Lorsque cette option est activée, les armes se rechargent automatiquement lorsque leurs munitions sont épuisées."
actionText="Rechargement auto."
...
[AugHeartLung]
AugmentationName="Coeur artificiel"
Description="Ce coeur artificiel pompe non seulement du sang mais également un liquide à forte concentration en cellules énergétiques mécanochimiques, phagocytes intelligents et liposomes contenant des pièces mécaniques en forme de diamant, entraînant une amplification des performances de toutes les modifications installées.|n|nAUCUNE AMPLIFICATION"

[Seagull]
FamiliarName="Mouette"
UnfamiliarName="Mouette"
...
[ChildMale]
FamiliarName="Enfant"
UnfamiliarName="Enfant"

[HKBuddha]
ItemName="Statue de Buddha"

[HKBirdcage]
ItemName="Cage à oiseau"
...
ItemName="Caisse de matériel médical"
...
[CrateExplosiveSmall]
ItemName="Caisse de TNT"

[CrateUnbreakableLarge]
ItemName="Caisse métallique"
...
[ComputerPersonal]
ItemName="Ordinateur personnel"

[HKChair]
ItemName="Chaise"

[Butler]
FamiliarName="Maître d'hôtel"
UnfamiliarName="Maître d'hôtel"

[Businesswoman1]
FamiliarName="Femme d'affaires"
UnfamiliarName="Femme d'affaires"

[Businessman3]
FamiliarName="Homme d'affaires"
UnfamiliarName="Homme d'affaires"
...
[Hooker1]
FamiliarName="Prostituée"
UnfamiliarName="Prostituée"

[CrateBreakableMedCombat]
ItemName="Caisse de matériel militaire"
...
[BoxSmall]
ItemName="Boîte en carton"

[DentonClone]
ItemName="Clone de JC Denton"
...
[BoatPerson]
FamiliarName="Boat People"
UnfamiliarName="Boat People"

[WHDeskLibrarySmall]
ItemName="Bureau"

[WHChairOvalOffice]
ItemName="Fauteuil en cuir"
...
[Van]
ItemName="Camionnette noire"

[Bartender]
FamiliarName="Barman"
UnfamiliarName="Barman"

[Trophy]
ItemName="Trophée"

[TriadLumPath2]
FamiliarName="Chef de gang"
UnfamiliarName="Chef de gang"

[BarrelVirus]
ItemName="Bouteille contenant le nano-virus"
...
[SubwayControlPanel]
ItemName="Panneau de commande du métro"

[Soldier]
FamiliarName="Soldat"
UnfamiliarName="Soldat"

[Smuggler]
FamiliarName="Contrebandier"
UnfamiliarName="Contrebandier"

[SignFloor]
ItemName="Panneau d'avertissement"
...
[SecretService]
FamiliarName="Agent des services secrets"
UnfamiliarName="Agent des services secrets"

[Secretary]
FamiliarName="Secrétaire"
UnfamiliarName="Secrétaire"

[ScientistMale]
FamiliarName="Scientifique"
UnfamiliarName="Scientifique"
...
[NYPoliceBoat]
ItemName="Vedette de la police"
UnfamiliarName="Pilote de la vedette de l'UNATCO"

[Nurse]
FamiliarName="Infirmière"
UnfamiliarName="Infirmière"
...
[Janitor]
FamiliarName="Agent d'entretien"
UnfamiliarName="Agent d'entretien"
...
[Maid]
FamiliarName="Femme de chambre"
UnfamiliarName="Femme de chambre"
...
[LuciusDeBeers]
ItemName="Lucius De Beers dans un caisson de survie"

[LowerClassMale2]
FamiliarName="Ouvrier"
UnfamiliarName="Ouvrier"
...
[Lamp3]
ItemName="Lampe de bureau"

[Lamp2]
ItemName="Lampe halogène"

[Lamp1]
ItemName="Lampe de table"
...
[KarkianBaby]
FamiliarName="Bébé Karkian"
UnfamiliarName="Bébé Karkian"
...
[SkillSwimming]
SkillName="Nager"
Description="Les opérations sub-aquatiques nécessitent des capacités toutes particulières que l'agent se doit de suivre avec zèle.|n|nNUL: l'agent peut nager normalement.|n|nNOVICE: la vitesse et la capacité pulmonaire de l'agent augmentent légèrement.|n|nQUALIFIE: la vitesse et la capacité pulmonaire de l'agent augmentent de façon significative.|n|nEXPERT: l'agent devient un véritable dauphin."

[SkillComputer]
SkillName="Informatique"
Description="Les applications plus ou moins légales de l'informatique.|n|nNUL: l'agent peut utiliser les terminaux pour lire les informations.|n|nNOVICE: l'agent peut pirater les distribanques, les ordinateurs et les terminaux de sécurité.|n|nQUALIFIE: l'agent améliore ses capacités d'atténuation des comptes à rebours et sa vitesse de piratage, ainsi que la possibilité de contrôler les tourelles de sécurité.|n|nEXPERT: l'agent est un pirate d'élite auquel aucun système ne résiste."

[SkillTech]
SkillName="Electronique"
Description="En étudiant l'électronique et ses applications pratiques, les agents peuvent apprendre à pirater plus efficacement un certain nombre de systèmes de sécurité en utilisant des décodeurs.|n|nNUL: l'agent peut pirater les systèmes de sécurité.|n|nNOVICE: l'agent est capable de pirater les systèmes de sécurité plus facilement.|n|nQUALIFIE: l'agent est capable de pirater les systèmes de sécurité bien plus facilement.|n|nEXPERT: aucun système de sécurité ne saurait résister à l'agent."
MultitoolString="Décodage"

[SkillLockpicking]
SkillName="Crochetage"
Description="L'art du crochetage nécessite, outre des passe-partout, une patience et une grande concentration de la part de l'agent.|n|nNUL: l'agent sait crocheter une serrure.|n|nNOVICE: l'agent est capable de crocheter une serrure plus facilement.|n|nQUALIFIE: l'agent est capable de crocheter une serrure bien plus facilement.|n|nEXPERT: aucune serrure ne saurait résister à l'agent."

[SkillMedicine]
SkillName="Médecine"
Description="L'agent peut utiliser ses connaissances pratiques en matière de physiologie humaine sur le terrain afin de profiter au mieux des médikits.|n|nNUL: l'agent sait utiliser un médikit.|n|nNOVICE: l'agent peut guérir plus efficacement ses blessures et réduire la durée d'un empoisonnement.|n|nQUALIFIE: l'agent est bien plus efficace pour guérir ses blessures et réduire la durée d'un empoisonnement.|n|nEXPERT: l'agent peut effectuer un pontage coronarien avec des ustensiles de cuisine."

[Image12_Tiffany_HostagePic]
imageDescription="Photographie de Tiffany prise en otage"

[Image15_Area51_Sector4]
imageDescription="Secteur 4 de la Zone 51"

[Image15_BlueFusionDevice]
imageDescription="Système de Fusion bleue"

[Image15_Area51_Sector3]
imageDescription="Secteur 3 de la Zone 51"
...
[Image14_Schematic]
imageDescription="Composant du Constructeur Universel"

[Image14_OceanLab]
imageDescription="Labo maritime"

[Image12_Vandenberg_Sub]
imageDescription="Sous-marin de Vandenberg"

[Image12_Vandenberg_Command]
imageDescription="Poste de commandement de Vandenberg"

[Image11_Paris_CathedralEntrance]
imageDescription="Entrée de cathédrale"

[Image11_Paris_Cathedral]
imageDescription="Cathédrale de Paris"

[Image10_Paris_Metro]
imageDescription="Plan du métro de Paris"

[Image10_Paris_CatacombsTunnels]
imageDescription="Catacombes de Paris - Souterrains"

[Image10_Paris_Catacombs]
imageDescription="Catacombes de Paris"

[Image09_NYC_Ship_Top]
imageDescription="PCRS Wall Cloud: Ponts supérieurs"

[Image09_NYC_Ship_Bottom]
imageDescription="PCRS Wall Cloud: Ponts inférieurs"

[Image08_JoeGreenMIBMJ12]
imageDescription="Joe Greene, MIB du MJ12"
...
imageDescription="Héliport du MJ12"

[Image06_HK_Market]
imageDescription="Marché de Hong Kong"
...
imageDescription="Terrain d'aviation de NY"

[Image03_747Diagram]
imageDescription="Diagramme du 747"

[Image02_NYC_Warehouse]
imageDescription="Entrepôt de NY"

[Image02_Ambrosia_Flyer]
imageDescription="Prospectus sur l'Ambroisie"

[Image01_TerroristCommander]
imageDescription="Chef des terroristes"

[Image01_LibertyIsland]
imageDescription="Photo satellite de Liberty Island"

[Image01_GunFireSensor]
imageDescription="Détecteur de coups de feu"

[ChargedPickup]
ChargeRemainingLabel="Charge restante:"

[MenuChoice_OnOff]
enumText[0]="Désactivé"
enumText[1]="Activé"

[MenuChoice_EnabledDisabled]
enumText[0]="Activé"
enumText[1]="Désactivé"
...
[deusexserverping]
AdminEmailText="Email de l'Admin"
AdminNameText="Nom de l'Admin"
ChangeLevelsText="Changer les niveaux"
MultiplayerBotsText="Bots en multijoueurs"
FragLimitText="Limite de frags"
TimeLimitText="Limite de temps"
GameModeText="Mode de jeu"
GameTypeText="Type de jeu"
GameVersionText="Version de jeu"
WorldLogText="ngWorldStats"
MutatorsText="Mutators"
TrueString="Activé"
FalseString="Désactivé"
ServerAddressText="Adresse serveur"
GoalTeamScoreText="Score requis pour l'équipe"
MinPlayersText="Nombre min. de bots dans la partie"
PlayersText="Joueurs"
MaxTeamsText="Equipes max."
BalanceTeamsText="Equilibrer les équipes par des bots"
PlayersBalanceTeamsText="Equilibrer les équipes"
FriendlyFireText="Dommages tirs amis"
MinNetVersionText="Version min. compatible"
BotSkillText="Compétence Bot"
TournamentText="Mode Tournoi"
ServerModeText="Mode Serveur"
DedicatedText="Dédié"
NonDedicatedText="Non dédié"
WorldLogWorkingText="ngWorldStats Status"
WorldLogWorkingTrue="Traitement correct des stats"
WorldLogWorkingFalse="Traitement incorrect des stats"
StartingSkillsText="Points de compétence initiaux"
SkillsPerKillText="Points de compétence par tué"
StartingAugsText="Modifications initiales"
AugsPerKillText="Modifications par tué"
...
StreakString="Séquence actuelle"
KillsString="Tués"
DeathsString="Morts"
PlayerString="Joueur"
NewMapSecondsString=" secondes avant la nouvelle zone."
WonMatchString=" a gagné la partie !"
PingString="Ping"
EscapeString="Appuyez sur <Echap> pour vous déconnecter."
MatchEnd1String="Au terme de cette partie "
MatchEnd2String=" a éliminé "
TeamNsfString="L'Equipe NSF"
TeamUnatcoString="L'Equipe UNATCO"
TeamDrawString="Egalité en fin de partie !"
...
KilledByString="Vous avez été tué par "
...
RefreshButtonHelpText="Actualiser la liste des serveurs"
strHostNameLabel="Nom de l'hôte"
strMapNameLabel="Zone"
strGameTypeLabel="Type de partie"
strNumPlayersLabel="Joueurs"
strPingLabel="Ping"
GameTypeOneLabel="Afficher les parties Deathmatch"
GameTypeTwoLabel="Afficher les parties Deathmatch par équipe"
ShowAllGameTypesLabel="Afficher toutes les parties"
GameHumanNames[0]="Deathmatch"
GameHumanNames[1]="Deathmatch par équipe"
GameHumanNames[2]="DM av. par équipe"
...
[menuscreenaugsetup]
HeaderAugChosenLabel="Priorités de modification"
actionButtons[0]="(Align=HALIGN_Right,Action=AB_Cancel)"
actionButtons[1]="(Align=HALIGN_Right,Action=AB_Reset)"
actionButtons[2]="(Action=AB_OK)"
Title="Paramètres Modification en multijoueurs"
 
[dxmaplist]
CycleNames[0]="Refaire la zone"
CycleNames[1]="Zone aléatoire"
...
TimeLimitActionText="Limite de temps (minutes)"
FragLimitActionText="Limite de tués"
TimeLimitHelpText="Nombre de minutes avant la fin de la partie"
FragLimitHelpText="Nombre de tués nécessaire pour remporter la partie"
actionText=""
configSetting="DeusExMPGame ScoreToWin"
 
[menuscreenjoinlan]
Title="Commencer la partie multijoueurs en réseau local"
 
[menuchoice_gametype]
gameNames[0]="Deathmatch"
gameNames[1]="Deathmatch de base par équipe"
gameNames[2]="Deathmatch avancé par équipe"
gameNames[3]="Deathmatch personnalisé par équipe"
HelpText="Type de partie sélectionnée"
actionText="Type de partie"
...
[menuchoice_map]
HelpText="Zone sur laquelle la partie commence (le nombre de joueurs proposés figure sur la zone)"
actionText="Zone"
configSetting="DXMapList MapNum"
 
[ammocrate]
AmmoReceived="Munitions reconstituées"
ItemName="Caisse de munitions"
 
[menuscreenplayersetup]
HeaderPlayerNameLabel="Nom du joueur"
actionButtons[0]="(Align=HALIGN_Right,Action=AB_Cancel)"
actionButtons[1]="(Align=HALIGN_Right,Action=AB_Reset)"
actionButtons[2]="(Action=AB_OK)"
...
VictoryNames[1]="Limite de temps"
HelpText="Détermine les différents événements nécessaires pour remporter une partie."
actionText="Conditions de victoire"
configSetting="DeusEXMPGame VictoryCondition"
 
[menuchoice_cycle]
HelpText="Détermine comment le serveur choisit une zone lorsque la précédente est terminée."
actionText="Cycle des zones"
...
TeamNames[1]="NSF"
TeamNames[2]="AUTO"
HelpText="Choix de l'équipe dans laquelle jouer."
actionText="Modèle d'équipe"
 
[menuchoice_skilllevel]
LevelNames[0]="Novice(1)"
...
ModeNames[0]="Dédié"
ModeNames[1]="Non dédié"
HelpText="Type de serveur à utiliser. Les serveurs dédiés n'ont pas de joueur local mais fonctionnent plus rapidement."
actionText="Mode Serveur"
configSetting="MenuScreenHostGame ServerMode"
 
[menuchoice_class]
ClassNames[0]="JC Denton"
ClassNames[1]="Terroriste NSF"
ClassNames[2]="Para UNATCO"
ClassNames[3]="Agent Majestic-12"
HelpText="Modèle pour votre personnage pour les parties sans équipe."
actionText="Modèle sans équipe"
 
[menuchoice_connection]
ConnectionNames[0]="Modem"
ConnectionNames[1]="DSL ou mieux"
HelpText="Type de connexion Internet"
actionText="Type de connexion"
...
HelpText="L'affichage ou non, au cours des parties multijoueurs, de messages vous informant des règles de la partie."
actionText="Messages d'aide"
configSetting="DeusExPlayer bHelpMessages"
 
[menuchoice_augsallowed]
HelpText="Fixe si les joueurs reçoivent ou non des modifications initiales et des modifications pour un certain nombre de tués."
...
[menuchoice_augbonus]
HelpText="Fixe la quantité de modifications additionnelles attribuée à chaque joueur par tué."
actionText="Modifications par tué"
configSetting="DeusExMPGame AugsPerKill"
 
[menuchoice_Startingaugs]
HelpText="Fixe la quantité initiale de modifications d'un joueur."
actionText="Modifications initiales"
