...
[NanoKey0]
Description="Code de l'armurerie de l'entrepôt"
...
Views[1]="(titleString="Armurerie",cameraTag=B_Sector2,doorTag=AmmoStorageDoor)"
Views[2]="(titleString="Bureau du commandant",cameraTag=C_Sector2,doorTag=ArmoryDoor)"
...
[Mechanic2]
FamiliarName="Autre docker"
UnfamiliarName="Autre docker"

[Mechanic1]
FamiliarName="Docker"
UnfamiliarName="Docker"

[NanoKey1]
Description="Code de l'armoire à fournitures"

[NanoKey2]
Description="Code du bureau du commandant"
...
[ComputerSecurity0]
Views[0]="(titleString="Bureau de l'entrepôt",cameraTag=A_Sector1,doorTag=SecurityDoor)"
Views[1]="(titleString="Entrepôt, E",cameraTag=B_Sector1)"
Views[2]="(titleString="Entrepôt, O",cameraTag=C_Sector1)"
...
[NanoKey4]
Description="Ouvre les remorques du parking"
