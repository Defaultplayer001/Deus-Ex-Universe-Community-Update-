[ComputerSecurity3]
specialOptions[0]="(Text="Activer les robots de sécurité",TriggerEvent=upper1_release,bTriggerOnceOnly=True)"
...
[ComputerSecurity0]
Views[0]="(titleString="Routeur Aquinas",cameraTag=camera_helios_room,doorTag=door_helios_room)"
