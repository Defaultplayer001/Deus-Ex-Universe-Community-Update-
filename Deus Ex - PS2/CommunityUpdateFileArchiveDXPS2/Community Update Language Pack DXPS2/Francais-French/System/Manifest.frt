[Setup]
LocalProduct=Deus Ex PS2
DefaultFolder=C:\DeusExPS2
ReadMe=Help\ReadMe.htm
SetupWindowTitle=Installation de Deus Ex PS2
...
[General]
PlayLevelCommand=&Jouer à ce niveau de Deus Ex
OpenLinkCommand=&Ouvrir ce lien de Deus Ex
EditLevelCommand=&Éditer ce niveau de Deus Ex
...
Description=La peau de Deus Ex (textures, effets sonores, musique) - à installer pour améliorer les performances du jeu : sans cela, les éléments seront chargés depuis le CD en cours de partie. Installation optionnelle.

[DeusExMapsGroup]
Caption=Cartes de Deus Ex
Description=Le squelette de Deus Ex - à installer pour améliorer les performances du jeu : sans cela, les cartes seront chargées depuis le CD en cours de partie. Installation optionnelle.

[DeusExSpeechGroup]
Caption=Dialogues de Deus Ex
Description=La voix de Deus Ex - à installer pour améliorer les performances du jeu : sans cela, les dialogues seront chargés depuis le CD en cours de partie. Installation optionnelle.

[EditorGroup]
Caption=Éditeur de Deus Ex
Description=La main de Deus Ex, pour que vous puissiez créer vos propres environnements 3D pour Deus Ex. A réserver aux utilisateurs chevronnés. Installation optionnelle.

[DirectXGroup]
Caption=DirectX
Description=Pilotes Microsoft DirectX 7.0a pour une meilleure gestion des graphismes, du son et des manettes. Si DirectX 7.0a n'est pas encore installé sur votre système d'exploitation, vous devez retenir cette option.

[PlayShortcut]
Caption=Jouer à Deus Ex
...
;//  PatchFixShortcut and PatchGroup added from 1112fm patch manifest.int for Unofficial Patch v3 by Defaultplayer 2018/04/21  //
...
;//  DemoGroup added for Unofficial Patch v3 by Defaultplayer 2018/04/21  //
